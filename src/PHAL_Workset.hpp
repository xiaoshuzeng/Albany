...
typedef Albany::DistributedParameterLibrary<Epetra_Vector, Epetra_MultiVector, Albany::IDArray> DistParamLib;
typedef Albany::DistributedParameter<Epetra_Vector, Epetra_MultiVector, Albany::IDArray> DistParam;
