...
Albany::HMCEvaluatorUtils<EvalT,Traits>::HMCEvaluatorUtils(
...
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructGatherSolutionEvaluator(
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructGatherSolutionEvaluator_withAcceleration(
       Teuchos::ArrayRCP<std::string> dof_names,
       Teuchos::ArrayRCP<std::string> dof_names_dot, 
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructGatherSolutionEvaluator_noTransient(
       Teuchos::ArrayRCP<std::string> dof_names,
       int offsetToFirstDOF)
{
    using Teuchos::RCP;
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructScatterResidualEvaluator(
       ...
       int offsetToFirstDOF, std::string scatterName)
{
    ...
    return rcp(new HMC::ScatterResidual<EvalT,Traits>(*p,dl));
}

template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructGatherCoordinateVectorEvaluator()
{
    using Teuchos::RCP;
    using Teuchos::rcp;
    using Teuchos::ParameterList;
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructGatherSHeightEvaluator()
{
    using Teuchos::RCP;
    using Teuchos::rcp;
    using Teuchos::ParameterList;
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructGatherTemperatureEvaluator()
{
    using Teuchos::RCP;
    using Teuchos::rcp;
    using Teuchos::ParameterList;
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructGatherSurfaceVelocityEvaluator()
{
    using Teuchos::RCP;
    using Teuchos::rcp;
    using Teuchos::ParameterList;
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructGatherVelocityRMSEvaluator()
{
    using Teuchos::RCP;
    using Teuchos::rcp;
    using Teuchos::ParameterList;
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructGatherFlowFactorEvaluator()
{
    using Teuchos::RCP;
    using Teuchos::rcp;
    using Teuchos::ParameterList;
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructMapToPhysicalFrameEvaluator(
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructComputeBasisFunctionsEvaluator(
    const Teuchos::RCP<shards::CellTopology>& cellType,
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructDOFInterpolationEvaluator(
       std::string& dof_name,
       int offsetToFirstDOF)
{
    using Teuchos::RCP;
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructDOFGradInterpolationEvaluator(
       std::string& dof_name,
       int offsetToFirstDOF)
{
    using Teuchos::RCP;
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructDOFGradInterpolationEvaluator_noDeriv(
       std::string& dof_name)
{
    using Teuchos::RCP;
    using Teuchos::rcp;
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructDOFTensorInterpolationEvaluator(
       std::string& dof_name,
       int offsetToFirstDOF)
{
    using Teuchos::RCP;
...
template<typename EvalT, typename Traits>
Teuchos::RCP< PHX::Evaluator<Traits> >
Albany::HMCEvaluatorUtils<EvalT,Traits>::constructDOFTensorGradInterpolationEvaluator(
       std::string& dof_name,
       int offsetToFirstDOF)
{
    using Teuchos::RCP;
